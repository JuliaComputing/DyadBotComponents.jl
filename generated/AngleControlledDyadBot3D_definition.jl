...
@doc Markdown.doc"""
   AngleControlledDyadBot3D(; name, k_angle, Ti_angle, Td_angle, phi0)
...
"""
@component function AngleControlledDyadBot3D(; name = nothing, k_angle=0.487401, Ti_angle=0.0587352, Td_angle=0.0420526, phi0=0.1, kwargs...)
  isnothing(name) && throw(ArgumentError("""
    The `name` keyword must be provided. Please consider using the `@named` macro,
    like so:
  
    @named model = AngleControlledDyadBot3D()
  """))
...
export AngleControlledDyadBot3D
