...
@component function RollingDyadBot3D(; name = nothing, M=0.1, m=0.05, R=0.04, L=0.08, Ib=0.00025, Iw=0.0001, d=0.0001, phi0=Float64(0.0), track=0.13, kwargs...)
  ...
  push!(__eqs, connect(torquesource1.spline, wheels.axis1, encoder1.spline, speedsensor1.spline))
  push!(__eqs, connect(torquesource2.spline, wheels.axis2, encoder2.spline, speedsensor2.spline))
  ...
  push!(__eqs, connect(torquesource1.support, damper1.spline_a, torquesource2.support, damper2.spline_a, tilt_rate_sensor.spline, pitch.axis, tilt_sensor.spline))
  push!(__eqs, connect(encoder1.phi, odometry_yaw.u1, odometry_pos.u1))
