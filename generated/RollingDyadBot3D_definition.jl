...
@component function RollingDyadBot3D(; name = nothing, M=0.1, m=0.05, R=0.04, L=0.08, Ib=0.00025, Iw=0.0001, d=0.0001, phi0=Float64(0.0), track=0.13, kwargs...)
  ...
  push!(__eqs, connect(wheels.frame_middle, pitch.frame_a))
  push!(__eqs, connect(pitch.frame_b, body.frame_a))
  push!(__eqs, connect(torque, gain_half.u))
  push!(__eqs, connect(gain_half.y, torque_left.tau, torque_right.tau))
  push!(__eqs, connect(torque_left.spline, damper_left.spline_a, wheels.axis1))
  push!(__eqs, connect(torque_right.spline, damper_right.spline_a, wheels.axis2))
  push!(__eqs, connect(torque_left.support, torque_right.support, damper_left.spline_b, damper_right.spline_b, pitch.axis))
